...
ENDPOINTS:
    ...
    POST /api/discover → Discover hidden outdoor gems
    GET  /health/mcp   → Check MCP weather server status (NEW!)
...
# Import the agent from our IGotYou_Agent module
...
async def discover_gems(request: DiscoveryRequest):
    ...
    Discovery → Analysis → Recommendation → Weather
    ...
    try:
        ...
        # This goes through: Discovery → Analysis → Recommendation → Weather
...
if __name__ == "__main__":
    ...
    print("🌤️ MCP Weather: Check /health/mcp for status")
